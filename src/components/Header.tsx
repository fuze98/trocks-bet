...
export function Header() {
  ...
  return (
    <header className="h-16 bg-zinc-900 border-b border-zinc-800 flex items-center justify-between px-6 sticky top-0 z-50">
      ...
      <div className="flex items-center gap-6">
        ...
        >
          {oddsFormat === 'decimal' ? 'Decimal Odds' : 'American Odds'}
        </button>
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col items-end">
              ...
              <span className="text-xs text-green-400 font-mono">
                {balance !== null ? `$${balance.toFixed(2)} SCC` : 'Loading...'}
              </span>
            </div>
